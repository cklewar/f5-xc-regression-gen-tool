...
variables:
  ...
  RTE_{{ rte.name | upper }}_{{ provider | upper }}_COMMON_ARTIFACTS_FILE: "$ARTIFACTS_ROOT_DIR/rte_{{ rte.name }}_common.tfvars"
...
eut-apply:
  ...
  script:
      - |
        ...
        pwd
        ls -la
        ls -la $EUT_ROOT_DIR/aws
        ls -la $EUT_ROOT_DIR/azure
